...
import cmpInfoitemDiv from '@/components/cmp-infoitem-div.vue'

export default {
  components: {cmpGuessDetailDiv, cmpRightadDiv, cmpHousedetailDiv, cmpInfoitemDiv},
  data () {
    let dataBus = {
      // Property or method "houseData" is not defined on the instance but referenced during render
      // 一开始就要渲染，需要先定义
      houseData: []
    }
